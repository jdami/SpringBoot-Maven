...
public enum ResultEnum2 {
    ...
    private ResultEnum2(String code,String msg) {
        this.code = code;
        this.msg = msg;
    }
     ...
     * @return
     */
    public static ResultEnum2 getByCode(String code) {
        for (ResultEnum2 genum : values()) {
    ...
    public static ResultEnum2 nameOf(String name){
    	ResultEnum2 genum = null;
		if (name != null){
			for (ResultEnum2 type : ResultEnum2.values()) {
    ...
    public static ResultEnum2 msgOf(String msg){
    	ResultEnum2 genum = null;
		if (msg != null){
			for (ResultEnum2 type : ResultEnum2.values()) {
				if (type.msg.equalsIgnoreCase(msg))
					genum = type;
			}
		}
		return genum;
